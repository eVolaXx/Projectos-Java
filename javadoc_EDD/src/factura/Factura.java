 ...
 * @author Juan Carlos
 * @see LineaFactura
 * @param  getTotal ="Devuelve el precio total de la factura, calculado a partir del precio de cada linea 
 * Clase de una factura en JAVA, con otra clase llamada LineaFactura
 */
...
public class Factura {
	...
	/**
	 * Creamos el constructor de Factura
	 * @param idCliente
	 * @param nombreCliente
	 * @param lineas
	 */
