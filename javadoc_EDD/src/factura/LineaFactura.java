/**
 * @author Juan carlos
 * @param LineaFactura creamos el contructor de lineafactura
 * @param String toString Creamos el metodo toString
 * @param getTotal Devuelve el precio total de una linea. El precio de la unidad por la cantidad de productos 
